...
@EViewGroup(R.layout.human_adapter_odd)
public class HumanAdapterViewOdd extends LinearLayout implements HumanAdapterViewIntf{
	@ViewById
    ...
    public HumanAdapterViewOdd(Context context) {
        super(context);
    }

    /* (non-Javadoc)
     * @see com.android2ee.formation.librairies.androidannotation.exo.migrated.adapter.HumanAdapterViewIntf#bind(com.android2ee.formation.librairies.androidannotation.exo.migrated.Human)
     */
